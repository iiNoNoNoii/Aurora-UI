/*! Aurora UI v0.5.2-alpha | AGPL-3.0-or-later | Source: https://github.com/iiNoNoNoii/Aurora-UI */
const T = Math.PI * 2;
function x(s, t, e) {
...
const at = "aurora-background", gi = "Aurora Background", ne = "0.5.2-alpha", Xt = ["low", "medium", "high", "ultra"], mi = ["background", "card"], yi = {
  low: {
    level: "low",
    renderScale: 0.6,
    maxDpr: 1,
...
function ue(s, t) {
  const e = Xt.indexOf(s);
  return Xt[x(e + t, 0, Xt.length - 1)];
}
function bi() {
  if (typeof window > "u")
    return "medium";
...
const wi = "sun.sun";
function Xe(s) {
  const t = s ?? {}, e = t.effects ?? {}, i = t.appearance ?? {}, n = t.performance ?? {}, r = t.background ?? {}, o = typeof t.glass == "boolean" ? { enabled: t.glass } : t.glass ?? {}, a = t.sun_entity === null ? void 0 : typeof t.sun_entity == "string" && t.sun_entity.length > 0 ? t.sun_entity : wi, l = fe(
    t.quality,
    ["auto", "low", "medium", "high", "ultra"],
    "auto"
  );
  return {
    type: pe(t.type, `custom:${at}`),
    mode: fe(t.mode, mi, "background"),
    weather_entity: typeof t.weather_entity == "string" && t.weather_entity.length > 0 ? t.weather_entity : void 0,
    sun_entity: a,
    quality: l,
    debug: C(t.debug, !1),
    height: typeof t.height == "number" ? `${t.height}px` : pe(t.height, "320px"),
    effects: {
      sun: C(e.sun, !0),
      moon: C(e.moon, !0),
      stars: C(e.stars, !0),
    ...
    background: {
      ...
      css_variables: vi(r.css_variables),
    ...
    glass: {
      ...
      blur: O(o.blur, 14, 0, 40),
      opacity: O(o.opacity, 0.5, 0, 1),
      saturate: O(o.saturate, 1.4, 1, 3),
      border: C(o.border, !0),
      glow: O(o.glow, 1, 0, 2),
      radius: O(o.radius, 18, -1, 60),
 ...
 */
const zt = globalThis, re = zt.ShadowRoot && (zt.ShadyCSS === void 0 || zt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, oe = Symbol(), ge = /* @__PURE__ */ new WeakMap();
let Qe = class {
  constructor(t, e, i) {
    if (this._$cssResult$ = !0, i !== oe)
...
const _i = (s) => new Qe(typeof s == "string" ? s : s + "", void 0, oe), At = (s, ...t) => {
  ...
  return new Qe(e, s, oe);
}, Si = (s, t) => {
  if (re)
    s.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
  else
    for (const e of t) {
      const i = document.createElement("style"), n = zt.litNonce;
      n !== void 0 && i.setAttribute("nonce", n), i.textContent = e.cssText, s.appendChild(i);
    }
}, me = re ? (s) => s : (s) => s instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: $i, defineProperty: xi, getOwnPropertyDescriptor: Ci, getOwnPropertyNames: Mi, getOwnPropertySymbols: Ai, getPrototypeOf: Ei } = Object, Q = globalThis, ye = Q.trustedTypes, Ti = ye ? ye.emptyScript : "", Pi = Q.reactiveElementPolyfillSupport, _t = (s, t) => s, Ft = { toAttribute(s, t) {
  switch (t) {
    case Boolean:
      s = s ? Ti : null;
      break;
  ...
  return e;
} }, ae = (s, t) => !$i(s, t), be = { attribute: !0, type: String, converter: Ft, reflect: !1, useDefault: !1, hasChanged: ae };
...
let rt = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, i) {
    const { get: n, set: r } = Ci(this.prototype, t) ?? { get() {
      return this[e];
    }, set(o) {
      this[e] = o;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(_t("properties"))) {
      const e = this.properties, i = [...Mi(e), ...Ai(e)];
      for (const n of i)
  ...
  _$ET(t, e) {
    ...
    if (n !== void 0 && i.reflect === !0) {
      const r = (i.converter?.toAttribute !== void 0 ? i.converter : Ft).toAttribute(e, i.type);
  ...
  _$AK(t, e) {
    ...
    if (n !== void 0 && this._$Em !== n) {
      const r = i.getPropertyOptions(n), o = typeof r.converter == "function" ? { fromAttribute: r.converter } : r.converter?.fromAttribute !== void 0 ? r.converter : Ft;
      this._$Em = n;
  ...
  requestUpdate(t, e, i, n = !1, r) {
    if (t !== void 0) {
      ...
      if (n === !1 && (r = this[t]), i ?? (i = o.getPropertyOptions(t)), !((i.hasChanged ?? ae)(r, e) || i.useDefault && i.reflect && r === this._$Ej?.get(t) && !this.hasAttribute(o._$Eu(t, i))))
        return;
      this.C(t, e, i);
    }
...
rt.elementStyles = [], rt.shadowRootOptions = { mode: "open" }, rt[_t("elementProperties")] = /* @__PURE__ */ new Map(), rt[_t("finalized")] = /* @__PURE__ */ new Map(), Pi?.({ ReactiveElement: rt }), (Q.reactiveElementVersions ?? (Q.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const St = globalThis, ve = (s) => s, It = St.trustedTypes, we = It ? It.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, Ke = "$lit$", j = `lit$${Math.random().toFixed(9).slice(2)}$`, Ze = "?" + j, ki = `<${Ze}>`, it = document, xt = () => it.createComment(""), Ct = (s) => s === null || typeof s != "object" && typeof s != "function", le = Array.isArray, Oi = (s) => le(s) || typeof s?.[Symbol.iterator] == "function", Qt = `[ 	
\f\r]`, mt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, _e = /-->/g, Se = />/g, Z = RegExp(`>|${Qt}(?:([^\\s"'>=/]+)(${Qt}*=${Qt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), $e = /'/g, xe = /"/g, Je = /^(?:script|style|textarea|title)$/i, Ri = (s) => (t, ...e) => ({ _$litType$: s, strings: t, values: e }), E = Ri(1), st = Symbol.for("lit-noChange"), $ = Symbol.for("lit-nothing"), Ce = /* @__PURE__ */ new WeakMap(), tt = it.createTreeWalker(it, 129);
function ti(s, t) {
...
const Li = (s, t) => {
  ...
  let n, r = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", o = mt;
  for (let a = 0; a < e; a++) {
    const l = s[a];
    let h, c, d = -1, f = 0;
    for (; f < l.length && (o.lastIndex = f, c = o.exec(l), c !== null); )
      f = o.lastIndex, o === mt ? c[1] === "!--" ? o = _e : c[1] !== void 0 ? o = Se : c[2] !== void 0 ? (Je.test(c[2]) && (n = RegExp("</" + c[2], "g")), o = Z) : c[3] !== void 0 && (o = Z) : o === Z ? c[0] === ">" ? (o = n ?? mt, d = -1) : c[1] === void 0 ? d = -2 : (d = o.lastIndex - c[2].length, h = c[1], o = c[3] === void 0 ? Z : c[3] === '"' ? xe : $e) : o === xe || o === $e ? o = Z : o === _e || o === Se ? o = mt : (o = Z, n = void 0);
    const p = o === Z && s[a + 1].startsWith("/>") ? " " : "";
    r += o === mt ? l + ki : d >= 0 ? (i.push(h), l.slice(0, d) + Ke + l.slice(d) + j + p) : l + j + (d === -2 ? a : p);
  }
  return [ti(s, r + (s[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), i];
};
class Mt {
  constructor({ strings: t, _$litType$: e }, i) {
    ...
    this.parts = [];
    let r = 0, o = 0;
    const a = t.length - 1, l = this.parts, [h, c] = Li(t, e);
    if (this.el = Mt.createElement(h, i), tt.currentNode = this.el.content, e === 2 || e === 3) {
      ...
      if (n.nodeType === 1) {
        if (n.hasAttributes())
          for (const d of n.getAttributeNames())
            if (d.endsWith(Ke)) {
              const f = c[o++], p = n.getAttribute(d).split(j), u = /([.?@])?(.*)/.exec(f);
              l.push({ type: 1, index: r, name: u[2], strings: p, ctor: u[1] === "." ? zi : u[1] === "?" ? Fi : u[1] === "@" ? Ii : Ut }), n.removeAttribute(d);
            } else
              d.startsWith(j) && (l.push({ type: 6, index: r }), n.removeAttribute(d));
        if (Je.test(n.tagName)) {
          const d = n.textContent.split(j), f = d.length - 1;
          if (f > 0) {
            n.textContent = It ? It.emptyScript : "";
            for (let p = 0; p < f; p++)
              n.append(d[p], xt()), tt.nextNode(), l.push({ type: 2, index: ++r });
            n.append(d[f], xt());
          }
        }
...
function lt(s, t, e = s, i) {
  ...
  return n?.constructor !== r && (n?._$AO?.(!1), r === void 0 ? n = void 0 : (n = new r(s), n._$AT(s, e, i)), i !== void 0 ? (e._$Co ?? (e._$Co = []))[i] = n : e._$Cl = n), n !== void 0 && (t = lt(s, n._$AS(s, t.values), n, i)), t;
}
class Di {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: i } = this._$AD, n = (t?.creationScope ?? it).importNode(e, !0);
    tt.currentNode = n;
    let r = tt.nextNode(), o = 0, a = 0, l = i[0];
    for (; l !== void 0; ) {
      if (o === l.index) {
        let h;
        l.type === 2 ? h = new Et(r, r.nextSibling, this, t) : l.type === 1 ? h = new l.ctor(r, l.name, l.strings, this, t) : l.type === 6 && (h = new Ni(r, this, t)), this._$AV.push(h), l = i[++a];
      }
      o !== l?.index && (r = tt.nextNode(), o++);
    }
    return tt.currentNode = it, n;
  }
  p(t) {
    let e = 0;
...
class Et {
  ...
  _$AI(t, e = this) {
    t = lt(this, t, e), Ct(t) ? t === $ || t == null || t === "" ? (this._$AH !== $ && this._$AR(), this._$AH = $) : t !== this._$AH && t !== st && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Oi(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== $ && Ct(this._$AH) ? this._$AA.nextSibling.data = t : this.T(it.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: e, _$litType$: i } = t, n = typeof i == "number" ? this._$AC(t) : (i.el === void 0 && (i.el = Mt.createElement(ti(i.h, i.h[0]), this.options)), i);
    if (this._$AH?._$AD === n)
      this._$AH.p(e);
    else {
      const r = new Di(n, this), o = r.u(this.options);
  ...
  k(t) {
    ...
    let i, n = 0;
    for (const r of t)
      n === e.length ? e.push(i = new Et(this.O(xt()), this.O(xt()), this, this.options)) : i = e[n], i._$AI(r), n++;
    n < e.length && (this._$AR(i && i._$AB.nextSibling, n), e.length = n);
  }
  _$AR(t = this._$AA.nextSibling, e) {
    for (this._$AP?.(!1, !0, e); t !== this._$AB; ) {
      const i = ve(t).nextSibling;
      ve(t).remove(), t = i;
    }
  }
  setConnected(t) {
...
class Ut {
  ...
  _$AI(t, e = this, i, n) {
    ...
    let o = !1;
    if (r === void 0)
      t = lt(this, t, e, 0), o = !Ct(t) || t !== this._$AH && t !== st, o && (this._$AH = t);
    else {
      const a = t;
      let l, h;
      for (t = r[0], l = 0; l < r.length - 1; l++)
        h = lt(this, a[i + l], e, l), h === st && (h = this._$AH[l]), o || (o = !Ct(h) || h !== this._$AH[l]), h === $ ? t = $ : t !== $ && (t += (h ?? "") + r[l + 1]), this._$AH[l] = h;
    }
    o && !n && this.j(t);
  }
  j(t) {
...
const Hi = St.litHtmlPolyfillSupport;
Hi?.(Mt, Et), (St.litHtmlVersions ?? (St.litHtmlVersions = [])).push("3.3.3");
const Ui = (s, t, e) => {
  const i = e?.renderBefore ?? t;
  let n = i._$litPart$;
  if (n === void 0) {
    const r = e?.renderBefore ?? null;
    i._$litPart$ = n = new Et(t.insertBefore(xt(), r), r, void 0, e ?? {});
  }
  return n._$AI(s), n;
};
/**
...
let G = class extends rt {
  ...
  update(t) {
    const e = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = Ui(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
const Bi = $t.litElementPolyfillSupport;
Bi?.({ LitElement: G });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Gi = { attribute: !0, type: String, converter: Ft, reflect: !1, hasChanged: ae }, qi = (s = Gi, t, e) => {
...
function dt(s) {
  return (t, e) => typeof e == "object" ? qi(s, t, e) : ((i, n, r) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Vi = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, Wi = (s) => (...t) => ({ _$litDirective$: s, values: t });
let Yi = class {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ei = "important", ji = " !" + ei, ot = Wi(class extends Yi {
  constructor(s) {
    if (super(s), s.type !== Vi.ATTRIBUTE || s.name !== "style" || s.strings?.length > 2)
  ...
  update(s, [t]) {
    ...
    for (const i in t) {
      ...
      if (n != null) {
        this.ft.add(i);
        const r = typeof n == "string" && n.endsWith(ji);
        i.includes("-") || r ? e.setProperty(i, r ? n.slice(0, -11) : n, r ? ei : "") : e[i] = n;
      }
    }
    return st;
  }
  ...
  constructor(t) {
    this.options = t, this.element = null, this.pointerId = null, this.startX = 0, this.startY = 0, this.dragging = !1, this.holdTimer = null, this.holdFired = !1, this.onPointerDown = (e) => {
      ...
      if (!(e.pointerId !== this.pointerId || !this.element)) {
        if (!this.dragging) {
          if ((this.options.axis === "x" ? Math.abs(e.clientX - this.startX) : Math.abs(e.clientY - this.startY)) < Ki)
            return;
...
function ni(s, t) {
  Zi(s, "hass-more-info", { entityId: t });
}
function ri(s, t) {
  if (!(!s || !t))
    return s.states[t];
...
var Ji = Object.defineProperty, ts = Object.getOwnPropertyDescriptor, Gt = (s, t, e, i) => {
  for (var n = i > 1 ? void 0 : i ? ts(t, e) : t, r = s.length - 1, o; r >= 0; r--)
    (o = s[r]) && (n = (i ? o(t, e, n) : o(n)) || n);
  return i && n && Ji(t, e, n), n;
};
const ht = "aurora-climate", es = [86, 158, 232], Zt = [150, 176, 200], is = [246, 152, 74], ss = {
  off: "mdi:power",
  heat: "mdi:fire",
  cool: "mdi:snowflake",
...
class ut extends G {
  constructor() {
    super(...arguments), this.errorMessage = null, this.pendingTarget = null, this.drag = new si({
      axis: "x",
      onMove: (t) => this.onDragMove(t),
      onCommit: (t) => this.onDragMove(t, !0),
      onHold: () => this.openMoreInfo(),
      isDisabled: () => !this.config || I(this.entity) || !this.config.slider
  ...
  static getStubConfig(t) {
    ...
    return { type: `custom:${ht}`, entity: e ?? "climate.example" };
  }
  ...
  updated(t) {
    ...
    e && this.config?.slider ? this.drag.attach(e) : this.drag.detach(), this.dataset.unavailable = String(I(this.entity));
  }
  /* ---------------------------------------------------------------- *
   * State
   * ---------------------------------------------------------------- */
  ...
  get unit() {
    return ie(this.entity, "temperature_unit") ?? this.hass?.config?.unit_system?.temperature ?? "°C";
  }
  get currentTemp() {
  ...
  get accent() {
    if (this.entity?.state === "off" || I(this.entity))
      return Zt;
    const t = this.targetFraction;
    return t < 0.5 ? R(es, Zt, t * 2) : R(Zt, is, (t - 0.5) * 2);
  }
  get hvacModes() {
  ...
  sendTarget(t, e) {
    ...
    const i = () => {
      this.sendTimer = null, Nt(this.hass, "climate", "set_temperature", {
  ...
  setHvacMode(t) {
    this.config && Nt(this.hass, "climate", "set_hvac_mode", {
      entity_id: this.config.entity,
      hvac_mode: t
    });
  }
  openMoreInfo() {
    this.config && ni(this, this.config.entity);
  }
  cancelTimers() {
  ...
  actionText() {
    ...
    if (I(t))
      return "Unavailable";
    const e = ie(t, "hvac_action");
    return e && Jt[e] ? Jt[e] : Jt[t.state] ?? t.state.replace(/_/g, " ");
  }
  render() {
    ...
    if (!this.config)
      return $;
    const t = this.entity, e = I(t), i = this.accent, n = `${Math.round(i[0])}, ${Math.round(i[1])}, ${Math.round(i[2])}`, r = this.target, o = this.currentTemp, a = this.unit, l = this.hvacModes, h = ot({
    ...
    return E`
      <ha-card style=${h}>
        ...
        <div class="content">
          <div class="header">
            ...
            <div class="labels">
              <div class="name">${this.config.name ?? ai(t, this.config.entity)}</div>
              <div class="state">
                ${o !== null ? `Currently ${Me(o, 0.1)} ${a}` : "No sensor reading"}
              </div>
            </div>
          ...
          <div class="dial">
            ...
            <div class="target">
              ${r !== null ? E`
                    <span class="number">${Me(r, this.step)}</span
      ...
      (c) => E`
                      ...
                      >
                        <ha-icon .icon=${ss[c] ?? "mdi:tune"}></ha-icon>
                      </button>
                    `
    )}
                </div>
...
Gt([
  z()
], ut.prototype, "pendingTarget", 2);
customElements.get(ht) || customElements.define(ht, ut);
var ns = Object.defineProperty, rs = Object.getOwnPropertyDescriptor, qt = (s, t, e, i) => {
  for (var n = i > 1 ? void 0 : i ? rs(t, e) : t, r = s.length - 1, o; r >= 0; r--)
    (o = s[r]) && (n = (i ? o(t, e, n) : o(n)) || n);
  return i && n && ns(t, e, n), n;
};
const ct = "aurora-light", Ee = [255, 197, 122], Te = 1;
class pt extends G {
  constructor() {
    super(...arguments), this.errorMessage = null, this.pendingBrightness = null, this.drag = new si({
      axis: "x",
      onMove: (t) => this.onDragMove(t),
      onCommit: (t) => this.onDragCommit(t),
      onTap: () => this.toggle(),
      onHold: () => this.openMoreInfo(),
      isDisabled: () => !this.config || I(this.entity)
  ...
  static getStubConfig(t) {
    ...
    return { type: `custom:${ct}`, entity: e ?? "light.example" };
  }
  static getConfigElement() {
  ...
  onDragCommit(t) {
    ...
    const e = x(Math.round(t * 100), Te, 100);
    this.pendingBrightness = e, Nt(this.hass, "light", "turn_on", {
      entity_id: this.config.entity,
      brightness_pct: e
  ...
  toggle() {
    !this.config || I(this.entity) || (Nt(this.hass, "light", "toggle", { entity_id: this.config.entity }), this.pendingBrightness = null, this.clearPendingTimer());
  }
  openMoreInfo() {
    this.config && ni(this, this.config.entity);
  }
  ...
  stateText() {
    const t = this.entity;
    return t ? I(t) ? "Unavailable" : this.isOn ? this.supportsBrightness ? `${this.brightnessPercent}%` : "On" : "Off" : "Entity not found";
  }
  render() {
    if (this.errorMessage)
    ...
    if (!this.config)
      return $;
    const t = this.entity, e = !t, i = this.lightColor, n = `${Math.round(i[0])}, ${Math.round(i[1])}, ${Math.round(i[2])}`, r = this.brightnessPercent, o = this.isOn && !e, a = this.config.icon ?? (o ? "mdi:lightbulb" : "mdi:lightbulb-outline"), l = ot({
      "--aurora-light-rgb": n,
      "--aurora-light-glow": o ? String(m(0.25 + r / 100 * 0.55)) : "0",
      "--aurora-icon-alpha": o ? "0.3" : "0.12",
      "--aurora-icon-color": o ? v(i) : "inherit"
...
qt([
  z()
], pt.prototype, "pendingBrightness", 2);
...
const as = ["low", "medium", "high", "ultra"];
function Pe(s) {
  return as.indexOf(s);
}
class ls {
...
function us(s) {
  ...
  for (let e = 0; e < J.length - 1; e++) {
    ...
    if (s >= i.elevation && s <= n.elevation) {
      const r = wt(i.elevation, n.elevation, s);
      return ds(i.palette, n.palette, r);
    }
  }
  return { ...t.palette };
}
function li(s) {
  const t = wt(-4, 8, s), e = 1 - wt(-14, -2, s), i = wt(-16, -3, s) * (1 - wt(0, 10, s));
...
function te(s) {
  const { elevation: t, rising: e, weather: i, appearance: n, season: r } = s, o = us(t), { twilightFactor: a, dayFactor: l } = li(t), h = e ? hs : cs, c = a * 0.3, d = {}, f = {
    zenith: 0.02,
    upper: 0.08,
    middle: 0.22,
    lower: 0.5,
    ...
    ambient: 0.5,
    cloud: 0.45
  }, p = m(i.desaturation) * 0.8, u = 1 - m(i.skyDarkness) * 0.75, g = r ? fs * (0.35 + 0.65 * l) : 0, w = r ? r.saturation : 1;
  for (const b of he) {
    let S = R(o[b], h, c * f[b]);
    r && g > 0 && (S = R(S, r.tint, g * ps[b])), S = Xi(S, p), S = Kt(S, u), S = Qi(S, n.saturation * w), S = Kt(S, n.brightness), d[b] = S;
  }
  return d.cloud = Kt(d.cloud, _(1, 0.32, m(i.cloudDarkness))), d;
}
function gs(s, t, e, i) {
...
function bs(s, t, e) {
  const i = ys(s), n = H(357.5291 + 0.98560028 * i), r = H(280.459 + 0.98564736 * i) + H(1.9148) * Math.sin(n) + H(0.02) * Math.sin(2 * n), o = H(23.4393 - 3563e-10 * i), a = Math.asin(Math.sin(o) * Math.sin(r)), l = Math.atan2(
    Math.cos(o) * Math.sin(r),
    Math.cos(r)
  ), c = H(280.16 + 360.9856235 * i) + H(e) - l, d = H(t), f = Math.sin(d) * Math.sin(a) + Math.cos(d) * Math.cos(a) * Math.cos(c), p = Math.asin(Math.max(-1, Math.min(1, f))), u = Math.atan2(
    Math.sin(c),
    Math.cos(c) * Math.sin(d) - Math.tan(a) * Math.cos(d)
  ), g = c + H(360.9856235 * (10 / 1440)), w = Math.sin(d) * Math.sin(a) + Math.cos(d) * Math.cos(a) * Math.cos(g);
  return {
    elevation: de(p),
    azimuth: Ht(de(u) + 180, 360),
    rising: w > f
  };
}
function vs(s) {
...
function ws(s, t, e) {
  const r = (s.getHours() + s.getMinutes() / 60 + s.getSeconds() / 3600 - 12) / 24 * T - e * T, o = 70 - Math.min(55, Math.abs(t) * 0.55), a = Math.cos(r) * o, l = (Math.sin(r) + 1) / 2;
...
function $s(s) {
  ...
  return _s.includes(t) ? t : Ss[t] ?? "unknown";
}
const xs = {
  cloudCover: 0.25,
  cloudDarkness: 0.05,
...
function Le(s, t, e = /* @__PURE__ */ new Date()) {
  ...
  if (c) {
    const b = Ot(c.attributes.elevation), S = Ot(c.attributes.azimuth);
    b !== null && (r = b, o = S, a = typeof c.attributes.rising == "boolean" ? c.attributes.rising : null, l = "sun.sun");
  }
  if (r === null || o === null || a === null) {
    const b = bs(e, i, n);
    r === null && (r = b.elevation), o === null && (o = b.azimuth), a === null && (a = b.rising), l !== "sun.sun" && (l = "computed");
  }
  const d = t.weather_entity ?? se(s), f = d ? s?.states?.[d] : void 0;
  let p = "unknown", u = null, g = null, w = !1;
  if (f && f.state !== "unavailable" && f.state !== "unknown") {
    p = $s(f.state), w = !0;
    const b = Ot(f.attributes.cloud_coverage);
    b !== null && (u = m(b / 100));
    const S = Ot(f.attributes.wind_speed);
    if (S !== null) {
      const P = String(
        f.attributes.wind_speed_unit ?? s?.config?.unit_system?.wind_speed ?? "km/h"
      ).toLowerCase(), q = S * (Ms[P] ?? 1);
      g = m(q / 70);
    }
  } else
...
class Ts {
  ...
  update(t, e = 4) {
    for (const i of Es)
      this.current[i] = Dt(this.current[i], this.target[i], e, t);
...
class Ps {
  ...
  render(t, e) {
    ...
    if (!this.gradient || o !== this.cacheKey) {
      ...
      h.addColorStop(0, v(i.zenith)), h.addColorStop(0.28, v(i.upper)), h.addColorStop(0.55, v(i.middle)), h.addColorStop(0.82, v(i.lower)), h.addColorStop(1, v(i.horizon)), this.gradient = h, this.cacheKey = o;
    }
...
class Os {
  ...
  setup(t) {
    const e = et(ks), i = t.quality.starCount;
  ...
  render(t, e) {
    ...
    for (let h = 0; h < this.stars.length; h++) {
      ...
      if (p <= 0.02)
        continue;
      const u = 255, g = 245 + Math.round(c.tint * 8), w = 225 + Math.round((1 - c.tint) * 30);
      t.fillStyle = `rgba(${u},${g},${w},${p.toFixed(3)})`, c.radius <= 0.7 ? t.fillRect(d, f, 1, 1) : (t.beginPath(), t.arc(d, f, c.radius, 0, T), t.fill());
    }
...
class Rs {
  ...
  render(t, e) {
    ...
    p.addColorStop(0, `rgba(200,220,255,${f.toFixed(3)})`), p.addColorStop(1, "rgba(200,220,255,0)"), t.fillStyle = p, t.beginPath(), t.arc(h, c, d, 0, T), t.fill(), t.globalCompositeOperation = "source-over", t.globalAlpha = i, t.drawImage(this.buffer, h - o / 2, c - o / 2), t.restore();
  }
  ensureBuffer(t) {
  ...
  drawMoon(t, e, i, n) {
    ...
    a.addColorStop(0, "#fffdf3"), a.addColorStop(0.75, "#eceadd"), a.addColorStop(1, "#cfd3cc"), t.fillStyle = a, t.beginPath(), t.arc(r, o, i, 0, T), t.fill(), t.fillStyle = "rgba(148,153,150,0.22)";
    const l = [
      [-0.28, -0.2, 0.3],
      [0.22, -0.32, 0.18],
      [0.12, 0.28, 0.26],
    ...
    for (const [d, f, p] of l)
      t.beginPath(), t.arc(r + d * i, o + f * i, p * i, 0, T), t.fill();
    const h = (1 - Math.cos(n * T)) / 2;
    if (h < 0.99) {
...
class Ls {
  ...
  render(t, e) {
    const { palette: i, width: n, height: r, appearance: o } = e, a = m(e.dayFactor * 0.35 + e.twilightFactor) * o.ambient_glow * _(0.45, 1, m(e.weather.sunVisibility));
    if (a > 0.01) {
      const g = m(e.sunX) * n, w = r * _(1.02, 0.55, m(e.dayFactor)), b = Math.max(n, r) * _(0.55, 0.95, e.twilightFactor), S = t.createRadialGradient(g, w, 0, g, w, b);
      S.addColorStop(0, v(i.sunGlow, 0.5 * a)), S.addColorStop(0.35, v(i.sunGlow, 0.22 * a)), S.addColorStop(1, v(i.sunGlow, 0)), t.fillStyle = S, t.fillRect(0, 0, n, r);
    }
    ...
    for (let g = p; g >= 1; g--) {
      const w = g / p, b = f * (2.2 + w * 9), S = 0.1 * l * o.ambient_glow * (1 - w * 0.55), P = t.createRadialGradient(h, c, f * 0.4, h, c, b);
      P.addColorStop(0, v(i.sunGlow, S)), P.addColorStop(1, v(i.sunGlow, 0)), t.fillStyle = P, t.beginPath(), t.arc(h, c, b, 0, T), t.fill();
    }
    const u = t.createRadialGradient(h, c, 0, h, c, f);
    u.addColorStop(0, v(i.sunCore, l)), u.addColorStop(0.7, v(i.sunCore, 0.85 * l)), u.addColorStop(1, v(i.sunGlow, 0)), t.fillStyle = u, t.beginPath(), t.arc(h, c, f, 0, T), t.fill(), t.restore();
  }
  destroy() {
  }
}
const Ds = 790741, zs = 2 * 2 * 3, Fs = 200, Is = [
  ...
  { style: "stratus", aspect: 3.2, spanScale: 1.45 },
  { style: "stratus", aspect: 3.2, spanScale: 1.45 }
], Ns = 0.22, Hs = 0.5, Us = 0.4;
class Bs {
  constructor() {
    this.name = "clouds", this.base = [], this.tinted = [], this.tintColor = [0, 0, 0], this.tintValid = !1, this.lastTintAt = 0, this.clouds = [];
  }
  setup(t) {
    const { cloudSpriteSize: e, cloudCount: i, cloudLayers: n } = t.quality, r = et(Ds), o = this.clouds;
    this.base = Is.map(({ style: a, aspect: l, spanScale: h }) => {
  ...
  render(t, e) {
    ...
    if (i <= 0.01 || this.clouds.length === 0 || (this.ensureTint(e.palette.cloud), this.tinted.length === 0))
      return;
    const { width: n, height: r, dt: o } = e, a = _(0.82, 1.35, i), l = i * this.clouds.length, h = Math.floor(l), c = l - h, d = _(0.25, 2.6, m(e.weather.wind)), f = e.reducedMotion ? 0.08 : 1, p = m((i - 0.55) / 0.45) * _(0.35, 0.85, m(e.weather.cloudDarkness));
    if (p > 0.01) {
      const u = t.createLinearGradient(0, 0, 0, r);
      u.addColorStop(0, v(e.palette.cloud, p * 0.55)), u.addColorStop(0.55, v(e.palette.cloud, p * 0.4)), u.addColorStop(1, v(e.palette.cloud, p * 0.18)), t.fillStyle = u, t.fillRect(0, 0, n, r);
    }
    t.save();
    for (let u = 0; u < this.clouds.length; u++) {
      const g = this.clouds[u], w = this.tinted[g.variant];
      let b = n * _(Ns, Hs, g.layer) * g.scale * w.spanScale * a, S = b / w.aspect;
      const P = r * Us;
      S > P && (S = P, b = S * w.aspect);
      const q = n + b * 1.1, A = n * _(6e-3, 0.028, g.layer) * d * f;
      if (g.nx = Ht(g.nx + A * o / q, 1), u > h)
        continue;
      const V = u === h ? c : 1;
      if (V <= 0.01)
        continue;
      const Pt = _(0.3, 1, g.layer), nt = g.nx * q - b + e.parallaxX * Pt, Yt = e.reducedMotion ? 0 : Math.sin(e.time * 0.12 + g.bobPhase) * g.bobAmount * r, K = g.ny * r + Yt + e.parallaxY * Pt;
      if (nt + b < 0 || nt > n)
        continue;
      const k = g.alpha * V * _(0.42, 0.92, i) * _(0.75, 1, g.layer) * _(1, 1.15, m(e.weather.cloudDarkness));
      t.globalAlpha = m(k), t.drawImage(w.canvas, nt, K, b, S);
    }
    t.restore();
  }
  ensureTint(t) {
    if (this.tintValid) {
      if (X(t, this.tintColor) < zs)
        return;
      const e = performance.now();
      if (e - this.lastTintAt < Fs)
        return;
      this.lastTintAt = e;
    } else
      this.lastTintAt = performance.now();
    this.tinted = this.base.map((e) => ({
      canvas: Ws(e.canvas, t),
      aspect: e.aspect,
...
function Gs() {
  ...
  return Rt = !!s && typeof s.filter == "string", Rt;
}
function qs(s, t) {
  const e = document.createElement("canvas");
...
function Vs(s, t, e, i) {
  ...
  r.fillStyle = "#ffffff";
  const f = o ? 9 : 14, p = d / (f * 0.85), u = Math.max(d * 0.2, d - p * 2.6), g = l + (d - u) / 2, w = u / Math.max(1, f - 1), b = (h - c) * (o ? 0.3 : 0.4), S = (k, L, F, N) => {
    r.beginPath(), r.ellipse(k, L, F, N, 0, 0, T), r.fill();
  };
  for (let k = 0; k < f; k++) {
    const L = k / (f - 1), F = g + L * u + (e() - 0.5) * w * 0.5, N = 0.34 + 0.66 * Math.pow(Math.sin(Math.PI * m(L)), o ? 0.55 : 0.4), kt = (h - c) * (o ? 1 : 0.74) * N * y(e, 0.6, 1), jt = p * y(e, 0.85, 1.25), ce = Math.min(jt * y(e, 1, 1.45), Math.max(3, kt * 0.7));
    S(F, h - kt + ce, jt, ce), S(
      F,
      h - b * y(e, 0.1, 0.4),
      jt * y(e, 0.95, 1.2),
  ...
  const P = o ? 7 : 9;
  for (let k = 0; k < P; k++) {
    const L = (k + y(e, 0.2, 0.8)) / P, F = g + m(L) * u, N = 0.4 + 0.6 * Math.sin(Math.PI * m(L)), W = p * y(e, 0.32, 0.6), kt = h - (h - c) * N * y(e, 0.35, 0.85) + W * 0.4;
    S(F, kt, W * y(e, 1, 1.35), W);
  }
  const q = qs(n, a), A = q.getContext("2d");
  if (!A)
    return q;
  A.globalCompositeOperation = "source-atop";
  const V = A.createLinearGradient(0, c, 0, h);
  V.addColorStop(0, "rgb(255,255,255)"), V.addColorStop(0.42, "rgb(238,240,244)"), V.addColorStop(0.78, "rgb(196,201,211)"), V.addColorStop(1, "rgb(152,159,174)"), A.fillStyle = V, A.fillRect(0, 0, s, t);
  const Pt = o ? 3 : 2;
  for (let k = 0; k < Pt; k++) {
    const L = l + d * y(e, 0.22, 0.78), F = h - (h - c) * y(e, 0.45, 0.85), N = t * y(e, 0.18, 0.32), W = A.createRadialGradient(L, F, 0, L, F, N);
    W.addColorStop(0, "rgba(255,255,255,0.55)"), W.addColorStop(1, "rgba(255,255,255,0)"), A.fillStyle = W, A.beginPath(), A.arc(L, F, N, 0, T), A.fill();
  }
  A.globalCompositeOperation = "destination-in";
  const nt = m((h - a * 1.5) / t), Yt = m((h + a * 1.2) / t), K = A.createLinearGradient(0, 0, 0, t);
  return K.addColorStop(0, "rgba(0,0,0,1)"), K.addColorStop(nt, "rgba(0,0,0,1)"), K.addColorStop(Math.max(Yt, nt + 1e-3), "rgba(0,0,0,0)"), K.addColorStop(1, "rgba(0,0,0,0)"), A.fillStyle = K, A.fillRect(0, 0, s, t), A.globalCompositeOperation = "source-over", q;
}
function Ws(s, t) {
  const e = document.createElement("canvas");
  e.width = s.width, e.height = s.height;
  const i = e.getContext("2d");
  return i && (i.drawImage(s, 0, 0), i.globalCompositeOperation = "multiply", i.fillStyle = v(t), i.fillRect(0, 0, e.width, e.height), i.globalCompositeOperation = "destination-in", i.drawImage(s, 0, 0), i.globalCompositeOperation = "source-over"), e;
}
const Ys = 3846, De = 3, ze = 512, Fe = 128, js = 6 * 6 * 3;
class Xs {
  constructor() {
  ...
  render(t, e) {
    ...
    for (const d of this.bands) {
      d.nx = Ht(d.nx + d.speed * l * a, 1);
      const f = this.tinted[d.variant], p = d.thickness * o, u = Math.max(r * 1.6, p * (ze / Fe)), g = e.reducedMotion ? 0 : Math.sin(e.time * 0.07 + d.bobPhase) * o * 0.012, w = d.ny * o - p / 2 + g + e.parallaxY * 1.4, b = -d.nx * u + e.parallaxX * 1.4;
      t.globalAlpha = m(d.alpha * i * 0.55), t.drawImage(f, b, w, u, p), t.drawImage(f, b + u, w, u, p);
    }
    t.restore();
    const h = o * 0.55, c = t.createLinearGradient(0, h, 0, o);
    c.addColorStop(0, v(n, 0)), c.addColorStop(1, v(n, 0.32 * i)), t.fillStyle = c, t.fillRect(0, h, r, o - h);
  }
  ensureTint(t) {
    this.tintValid && X(t, this.tintColor) < js || (this.tinted = this.base.map((e) => Ks(e, t)), this.tintColor = t, this.tintValid = !0);
  }
  destroy() {
...
function Qs(s, t, e) {
  ...
  for (let a = 0; a < r; a++) {
    const l = e() * s, h = t * y(e, 0.3, 0.7), c = s * y(e, 0.08, 0.22), d = t * y(e, 0.3, 0.6), f = y(e, 0.1, 0.28), p = [0];
    l < c ? p.push(s) : l > s - c && p.push(-s);
    for (const u of p) {
      const g = l + u, w = n.createRadialGradient(g, h, 0, g, h, Math.max(c, d));
      w.addColorStop(0, `rgba(255,255,255,${f.toFixed(3)})`), w.addColorStop(0.6, `rgba(255,255,255,${(f * 0.4).toFixed(3)})`), w.addColorStop(1, "rgba(255,255,255,0)"), n.fillStyle = w, n.beginPath(), n.ellipse(g, h, c, d, 0, 0, Math.PI * 2), n.fill();
    }
  }
...
class Js {
  ...
  setup(t) {
    const e = et(Zs), i = t.quality.rainParticles;
    this.drops = new Array(i);
    for (let n = 0; n < i; n++) {
      const r = n % yt, o = r / (yt - 1);
      this.drops[n] = {
        nx: e(),
        ny: e(),
        speed: _(0.75, 1.7, o) * y(e, 0.85, 1.15),
        length: _(0.02, 0.058, o) * y(e, 0.8, 1.3),
        band: r
      };
    }
  }
  ...
  render(t, e) {
    ...
    this.active = a;
    const l = _(0.06, 0.5, m(e.weather.wind)) * (e.reducedMotion ? 0.3 : 1), h = e.reducedMotion ? 0.25 : 1, c = R(e.palette.ambient, [225, 238, 255], 0.62);
    for (let d = 0; d < yt; d++) {
      const f = d / (yt - 1);
      t.strokeStyle = v(c, _(0.11, 0.3, f) * i), t.lineWidth = _(0.7, 1.4, f), t.lineCap = "round", t.beginPath();
      for (let p = d; p < a; p += yt) {
        ...
        const g = u.nx * n, w = u.ny * r, b = u.length * r;
        t.moveTo(g, w), t.lineTo(g - b * l, w - b);
      }
      t.stroke();
    }
  ...
  renderGroundMist(t, e, i) {
    ...
    l.addColorStop(0, v(e.palette.ambient, 0)), l.addColorStop(1, v(e.palette.ambient, 0.3 * a)), t.fillStyle = l, t.fillRect(0, o, n, r - o);
  }
  destroy() {
    this.drops.length = 0, this.active = 0;
  }
}
const tn = 6230212, bt = 3;
class en {
  constructor() {
    this.name = "snow", this.flakes = [], this.active = 0;
  }
  setup(t) {
    const e = et(tn), i = t.quality.snowParticles;
    this.flakes = new Array(i);
    for (let n = 0; n < i; n++) {
      const r = n % bt, o = r / (bt - 1);
      this.flakes[n] = {
        nx: e(),
        ny: e(),
        speed: _(0.035, 0.14, o) * y(e, 0.8, 1.25),
        radius: _(16e-4, 5e-3, o) * y(e, 0.8, 1.3),
        driftAmplitude: y(e, 8e-3, 0.035) * _(0.6, 1.4, o),
  ...
  render(t, e) {
    ...
    this.active = l;
    const h = e.reducedMotion ? 0.2 : 1, c = _(4e-3, 0.05, m(e.weather.wind)) * h, d = R(e.palette.ambient, [255, 255, 255], 0.85);
    for (let f = 0; f < bt; f++) {
      const p = f / (bt - 1);
      t.fillStyle = v(d, _(0.4, 0.85, p) * i), t.beginPath();
      for (let u = f; u < l; u += bt) {
        const g = this.flakes[u];
        g.ny += g.speed * h * o, g.nx += c * o, g.ny > 1.05 && (g.ny -= 1.1, g.nx = Math.random()), g.nx > 1.05 ? g.nx -= 1.1 : g.nx < -0.05 && (g.nx += 1.1);
        const w = e.reducedMotion ? 0 : Math.sin(e.time * g.driftFrequency + g.driftPhase) * g.driftAmplitude, b = (g.nx + w) * n, S = g.ny * r, P = g.radius * a;
        t.moveTo(b + P, S), t.arc(b, S, P, 0, T);
      }
      t.fill();
    }
  }
...
class sn {
  constructor() {
    this.name = "lightning", this.rng = et(Ie), this.strike = null, this.cooldown = 6;
  }
  setup() {
    this.rng = et(Ie), this.strike = null, this.cooldown = y(this.rng, 4, 12);
  }
  resize() {
  }
  particleCount() {
  ...
  render(t, e) {
    ...
    for (const p of a.flashes) {
      ...
      if (u < 0 || u > p.duration)
        continue;
      const g = u / p.duration, w = g < 0.18 ? g / 0.18 : Math.pow(1 - (g - 0.18) / 0.82, 2);
      l = Math.max(l, p.peak * w);
    }
    if (l <= 4e-3)
      return;
  ...
  createStrike(t) {
    ...
    const o = y(e, 0.12, 0.88), a = y(e, 0.05, 0.3), h = t.quality.lightningBolts && e() < 0.55 ? Ne(e, o, a, y(e, 0.55, 0.85)) : null, c = [];
    if (h) {
      const d = Math.floor(e() * 3);
      for (let f = 0; f < d; f++) {
        const p = h[1 + Math.floor(e() * (h.length - 2))];
        c.push(
          Ne(e, p.x, p.y, p.y + y(e, 0.08, 0.22), 0.45)
        );
      }
    }
    return {
...
class nn {
  constructor(t, e, i) {
    this.sky = new Ps(), this.stars = new Os(), this.moon = new Rs(), this.sun = new Ls(), this.clouds = new Bs(), this.fog = new Xs(), this.rain = new Js(), this.snow = new en(), this.lightning = new sn(), this.reducedMotion = !1, this.parallaxTargetX = 0, this.parallaxTargetY = 0, this.parallaxX = 0, this.parallaxY = 0, this.initialised = !1, this.config = t, this.quality = e, this.snapshot = i, this.renderers = [
      this.sky,
      this.stars,
      this.moon,
      this.sun,
      ...
      this.snow,
      this.lightning
    ], this.season = Re(/* @__PURE__ */ new Date(), i.latitude), this.blender = new Ts(hi(i.condition)), this.blender.snapTo(this.targetProfile()), this.elevation = i.sunElevation, this.azimuth = i.sunAzimuth, this.palette = te({
  ...
  setEnvironment(t) {
    this.snapshot = t, this.season = Re(/* @__PURE__ */ new Date(), t.latitude), this.state.season = this.season, this.blender.setTarget(this.targetProfile());
  }
  /**
  ...
  snapToTargets() {
    this.elevation = this.snapshot.sunElevation, this.azimuth = this.snapshot.sunAzimuth, this.parallaxX = this.parallaxTargetX, this.parallaxY = this.parallaxTargetY, this.blender.snapTo(this.targetProfile()), this.palette = te({
      elevation: this.elevation,
  ...
  update(t, e) {
    const i = this.state;
    i.dt = t, i.time = e, this.elevation = Dt(this.elevation, this.snapshot.sunElevation, 1.5, t), this.azimuth = rn(this.azimuth, this.snapshot.sunAzimuth, 1.5, t);
    const n = this.blender.update(t), r = te({
      elevation: this.elevation,
      rising: this.snapshot.sunRising,
      weather: n,
      appearance: this.config.appearance,
    ...
    this.palette = gs(this.palette, r, 0.6, t), this.config.effects.parallax && !this.reducedMotion ? (this.parallaxX = Dt(this.parallaxX, this.parallaxTargetX, 0.25, t), this.parallaxY = Dt(this.parallaxY, this.parallaxTargetY, 0.25, t)) : (this.parallaxX = 0, this.parallaxY = 0), i.parallaxX = this.parallaxX, i.parallaxY = this.parallaxY;
    const { dayFactor: o, nightFactor: a, twilightFactor: l } = li(this.elevation);
    ...
    const h = /* @__PURE__ */ new Date(), c = vs(h), d = ws(h, this.snapshot.latitude, c);
    i.moonPhase = c, i.moonX = _(0.08, 0.92, m(d.azimuthFraction)), i.moonY = x(1.02 - m(d.altitude / 70) * 0.88, 0.08, 1.1), i.moonVisible = this.config.effects.moon && d.altitude > 2 && a > 0.08 && c > 0.03 && c < 0.97;
  }
  render(t) {
...
class ln {
  ...
  update(t, e = !1) {
    ...
    r.setProperty("--aurora-ambient-color", v(n.ambient)), r.setProperty("--aurora-ambient-rgb", o(n.ambient)), r.setProperty("--aurora-sky-color", v(n.sky)), r.setProperty("--aurora-horizon-color", v(n.horizon)), r.setProperty("--aurora-accent-color", v(n.accent)), r.setProperty("--aurora-accent-rgb", o(n.accent)), r.setProperty("--aurora-glow-strength", n.glow.toFixed(3)), r.setProperty("--aurora-night", n.night.toFixed(3)), r.setProperty("--aurora-day", (1 - n.night).toFixed(3));
    const a = Bt(n.sky) > 140;
    r.setProperty("--aurora-contrast-color", a ? "#10151f" : "#f2f6ff");
    const l = R(n.ambient, a ? [12, 16, 24] : [235, 243, 255], 0.72);
    r.setProperty("--aurora-card-tint", v(l, a ? 0.5 : 0.14)), r.setProperty(
      "--aurora-card-border",
      v(a ? [255, 255, 255] : [255, 255, 255], a ? 0.28 : 0.16)
    ), r.setProperty("--aurora-season", t.season.name), r.setProperty("--aurora-condition", t.weather.condition);
  }
  changed(t, e) {
    return X(t.ambient, e.ambient) > Lt || X(t.sky, e.sky) > Lt || X(t.horizon, e.horizon) > Lt || X(t.accent, e.accent) > Lt || Math.abs(t.glow - e.glow) > 0.02 || Math.abs(t.night - e.night) > 0.02;
  }
...
], Ue = ["--primary-text-color", "--secondary-text-color"];
class dn {
  constructor() {
  ...
  update(t, e, i = !1) {
    ...
    if (!i && n - this.lastWrite < hn)
      return;
    const r = Bt(t.palette.middle) > 145, o = R(
      t.palette.ambient,
      r ? [14, 18, 27] : [226, 236, 252],
      0.7
    ), a = t.palette.sunGlow, l = m(t.dayFactor * 0.5 + t.twilightFactor * 0.9 + t.nightFactor * 0.25) * e.glow;
    if (!i && this.lastSurface && this.lastAccent && X(this.lastSurface, o) < He && X(this.lastAccent, a) < He && Math.abs(this.lastGlow - l) < 0.03) {
      this.lastWrite = n;
      return;
    }
    this.lastWrite = n, this.lastSurface = o, this.lastAccent = a, this.lastGlow = l, this.active = !0;
    const h = document.documentElement.style, c = m(e.opacity * (r ? 1.15 : 1)), d = v(o, c);
    h.setProperty("--aurora-glass-surface", d), h.setProperty("--ha-card-background", d), h.setProperty("--card-background-color", d), h.setProperty(
      ...
      "--ha-card-border-color",
      v(r ? [255, 255, 255] : [255, 255, 255], r ? 0.3 : 0.16)
    )) : (h.setProperty("--ha-card-border-width", "0px"), h.setProperty("--ha-card-border-color", "transparent"));
    const f = `0 6px 24px rgba(0,0,0,${(0.18 + (r ? 0.06 : 0.14)).toFixed(3)})`, p = l > 0.01 ? `, 0 0 36px ${v(a, m(l * 0.16))}` : "";
    if (h.setProperty("--ha-card-box-shadow", f + p), e.radius >= 0 ? h.setProperty("--ha-card-border-radius", `${e.radius}px`) : h.removeProperty("--ha-card-border-radius"), e.adaptive_text) {
      ...
      h.setProperty("--primary-text-color", v(u)), h.setProperty(
        "--secondary-text-color",
        v(R(u, o, 0.35), _(0.75, 0.85, m(l)))
      ), this.textActive = !0;
...
class Be {
   ...
   */
  constructor(t, e = 12) {
    this.lastUpdate = 0, this.element = document.createElement("div"), this.element.className = "aurora-debug", this.element.setAttribute("style", un(e)), t.appendChild(this.element);
  }
  update(t, e, i, n, r) {
...
const Ge = 42e5, pn = 0.06, qe = 0.012;
class ci {
  /**
  ...
  constructor(t, e, i, n = !1) {
    this.host = t, this.debugOverlay = null, this.resizeObserver = null, this.intersectionObserver = null, this.motionQuery = null, this.cssWidth = 0, this.cssHeight = 0, this.pixelRatio = 1, this.resizePending = !1, this.visible = !0, this.documentVisible = !0, this.destroyed = !1, this.firstFrame = !0, this.environmentTimer = null, this.scrollOffset = 0, this.pointerX = 0, this.pointerY = 0, this.onMotionPreferenceChange = (o) => {
      ...
      this.destroyed || (this.scene.setEnvironment(Le(this.hass, this.config)), this.engine.isRunning || this.renderOnce());
    }, this.frame = (o, a) => {
    ...
    }, this.config = e, this.hass = i, this.ambient = n ? new ln() : null, this.glass = n ? new dn() : null, this.canvas = document.createElement("canvas"), this.canvas.className = "aurora-canvas", this.canvas.setAttribute(
      "style",
      "position:absolute;inset:0;width:100%;height:100%;display:block;pointer-events:none;"
    ), this.host.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d", { alpha: !1 });
    const r = this.resolveQuality();
    this.performance = new ls(
      r,
      e.quality === "auto" && e.performance.auto_quality,
      Math.min(e.performance.max_fps, gt(r).maxFps)
    ), this.scene = new nn(
      e,
      gt(r),
      Le(i, e)
    ), this.engine = new os(this.frame), this.applyFrameCap(), this.applyCanvasFilter(), this.attachListeners(), this.measure(), this.scene.snapToTargets(), e.debug && (this.debugOverlay = new Be(this.host, this.debugTopOffset())), this.updateRunState();
  }
  /* ---------------------------------------------------------------- *
   * Public API
   * ---------------------------------------------------------------- */
  ...
  resolveQuality() {
    return this.config.quality === "auto" ? bi() : this.config.quality;
  }
  applyQuality(t) {
    const e = gt(t);
  ...
  applyFrameCap() {
    const t = gt(this.performance.quality);
  ...
  pushParallax() {
    ...
    this.scene.setParallaxTarget(
      this.pointerX * t * qe,
      this.scrollOffset * t * pn + this.pointerY * t * qe * 0.6
    );
  }
  updateRunState() {
  ...
  measure() {
    const t = this.host.getBoundingClientRect(), e = Math.max(1, Math.round(t.width)), i = Math.max(1, Math.round(t.height)), n = gt(this.performance.quality);
    let o = Math.min(window.devicePixelRatio || 1, n.maxDpr) * n.renderScale;
    const a = e * i * o * o;
    a > Ge && (o *= Math.sqrt(Ge / a));
    ...
    return this.cssWidth = e, this.cssHeight = i, this.pixelRatio = o, c && (this.canvas.width = l, this.canvas.height = h, this.scene.resize(e, i, o)), this.updateRunState(), c;
  }
  /**
...
const Ve = "aurora-background-root", We = "aurora-background-style";
class fn {
  constructor() {
  ...
  ensureMounted(t) {
    if (!this.root) {
      ...
      e.id = Ve, this.root = e, this.applyRootStyle(t), document.body.insertBefore(e, document.body.firstChild);
    }
    if (!this.layer && this.root) {
      const e = this.activeOwner ? this.owners.get(this.activeOwner) : void 0;
      this.layer = new ci(this.root, t, e?.hass, !0);
    }
  }
  applyRootStyle(t) {
...
`));
  ...
  writeStyle(t) {
    if (!this.styleElement) {
      ...
      e.id = We, document.head.appendChild(e), this.styleElement = e;
    }
...
`;
var mn = Object.defineProperty, yn = Object.getOwnPropertyDescriptor, ui = (s, t, e, i) => {
  for (var n = i > 1 ? void 0 : i ? yn(t, e) : t, r = s.length - 1, o; r >= 0; r--)
    (o = s[r]) && (n = (i ? o(t, e, n) : o(n)) || n);
  return i && n && mn(t, e, n), n;
};
const bn = {
...
const vn = [
  ...
  },
  {
    ...
    icon: "mdi:palette",
    schema: [
      D("intensity", 0, 2, 0.05),
      D("saturation", 0, 2, 0.05),
      D("brightness", 0.2, 2, 0.05),
      D("ambient_glow", 0, 2, 0.05),
      D("opacity", 0, 1, 0.05),
      D("blur", 0, 40, 1)
    ]
  },
...
class Vt extends G {
  constructor() {
    super(...arguments), this.config = {}, this.computeLabel = (t) => bn[t.name] ?? t.name;
  }
  setConfig(t) {
    this.config = { ...t };
  }
  get formData() {
    const t = Xe(this.config);
    return {
...
Please configure the card in YAML – see the repository README.
  ...
  onValueChanged(t) {
    ...
    const i = {
      ...this.config,
      type: this.config.type ?? `custom:${at}`,
      mode: e.mode,
      quality: e.quality,
      debug: !!e.debug,
      effects: e.effects,
...
var wn = Object.defineProperty, _n = Object.getOwnPropertyDescriptor, Wt = (s, t, e, i) => {
  for (var n = i > 1 ? void 0 : i ? _n(t, e) : t, r = s.length - 1, o; r >= 0; r--)
    (o = s[r]) && (n = (i ? o(t, e, n) : o(n)) || n);
  return i && n && wn(t, e, n), n;
};
const Sn = ["HUI-CARD-OPTIONS", "HUI-DIALOG-EDIT-CARD", "HUI-CARD-PREVIEW"];
function $n(s, t = 30) {
  let e = s;
  for (let i = 0; i < t && e; i++) {
    if (e instanceof HTMLElement && Sn.includes(e.tagName))
      return !0;
...
class ft extends G {
  ...
  setConfig(t) {
    try {
      this.config = Xe(t), this.errorMessage = null, this.resolvedWeatherEntity = this.config.weather_entity, this.lastWeatherState = void 0, this.lastSunState = void 0, this.dataset.mode = this.config.mode;
    } catch (e) {
  ...
  set hass(t) {
    if (this._hass = t, !t || !this.config)
      return;
    this.resolvedWeatherEntity || (this.resolvedWeatherEntity = se(t));
    ...
    e === this.lastWeatherState && i === this.lastSunState || (this.lastWeatherState = e, this.lastSunState = i, this.config.mode === "background" ? vt.updateHass(this, t) : this.cardLayer?.updateHass(t));
  }
  get hass() {
    return this._hass;
  }
  ...
  connectedCallback() {
    super.connectedCallback(), this.syncLayer(), requestAnimationFrame(() => {
      this.isConnected && (this.editing = this.preview || $n(this));
    });
  }
  disconnectedCallback() {
  ...
  syncLayer() {
    ...
    if (t.mode === "background") {
      this.destroyCardLayer(), this.mounted ? vt.update(this, t, this._hass) : (vt.acquire(this, t, this._hass), this.mounted = !0);
      return;
    }
    this.mounted && (vt.release(this), this.mounted = !1);
    ...
    e.style.height = t.height, this.cardLayer ? (this.cardLayer.updateConfig(t), this.cardLayer.updateHass(this._hass)) : this.cardLayer = new ci(e, t, this._hass);
  }
  destroyCardLayer() {
    this.cardLayer?.destroy(), this.cardLayer = null;
  }
  teardownLayer() {
    this.destroyCardLayer(), this.mounted && (vt.release(this), this.mounted = !1);
  }
  /* ---------------------------------------------------------------- *
   * Render
   * ---------------------------------------------------------------- */
...
Wt([
  dt({ type: Boolean })
], ft.prototype, "preview", 2);
Wt([
  z()
], ft.prototype, "config", 2);
Wt([
  z()
], ft.prototype, "editing", 2);
Wt([
  z()
], ft.prototype, "errorMessage", 2);
customElements.get(at) || customElements.define(at, ft);
var xn = Object.defineProperty, Cn = Object.getOwnPropertyDescriptor, pi = (s, t, e, i) => {
  for (var n = i > 1 ? void 0 : i ? Cn(t, e) : t, r = s.length - 1, o; r >= 0; r--)
    (o = s[r]) && (n = (i ? o(t, e, n) : o(n)) || n);
  return i && n && xn(t, e, n), n;
};
const Mn = {
  entity: "Entity",
  name: "Name",
...
class Tt extends G {
  constructor() {
    super(...arguments), this.config = {}, this.computeLabel = (t) => Mn[t.name] ?? t.name;
  }
  setConfig(t) {
    this.config = { ...t };
  }
...
customElements.get("aurora-light-editor") || customElements.define("aurora-light-editor", En);
customElements.get("aurora-climate-editor") || customElements.define("aurora-climate-editor", Pn);
const ee = "https://github.com/iiNoNoNoii/Aurora-UI", kn = [
  {
    type: at,
    name: gi,
...
], je = window.customCards = window.customCards || [];
for (const s of kn)
  je.some((t) => t.type === s.type) || je.push(s);
console.info(
  `%c AURORA UI %c v${ne} `,
...
export {
  ft as AuroraBackgroundCard,
  Vt as AuroraBackgroundEditor,
  ut as AuroraClimateCard,
  pt as AuroraLightCard
};
